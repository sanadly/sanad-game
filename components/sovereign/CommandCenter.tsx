...
export const CommandCenter = () => {
  ...
  const [activeTab, setActiveTab] = useState<'navigator' | 'dreams'>('navigator');
    ...
    <div className="h-full bg-pixel-dark border-l-4 border-gray-800 p-4 flex flex-col font-pixel">
      ...
      <div className="flex gap-2 mb-4">
        ...
        <button
          ...
          className={`flex-1 py-2 text-xs font-bold border-b-2 transition-colors ${
            activeTab === 'dreams' 
              ? 'border-sovereign-highlight text-sovereign-highlight' 
              : 'border-transparent text-gray-500 hover:text-gray-400'
          }`}
        >
          DREAM REGISTRY
      ...
      {activeTab === 'navigator' ? (
        <>
          ...
          <div className="flex-1 bg-gray-900 border-2 border-gray-700 rounded-lg overflow-hidden">
               <DreamsPane />
          </div>
      )}
    </div>
